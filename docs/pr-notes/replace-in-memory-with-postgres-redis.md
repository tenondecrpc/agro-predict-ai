...
- Connected profile: `helm template agropredict-ai ./helm -f ./helm/values.yaml`
- Air-gapped profile: `helm template agropredict-ai ./helm -f ./helm/values.yaml -f ./helm/values-air-gapped.yaml`
