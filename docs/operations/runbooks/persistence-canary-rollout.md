...
- Watch `agropredict_persistence_operation_seconds`, `agropredict_dlq_depth`, `agropredict_provider_circuit_breaker_state`, and burn-rate alerts during each pause.
