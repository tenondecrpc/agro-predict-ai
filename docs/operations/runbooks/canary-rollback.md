...
```bash
kubectl argo rollouts get rollout agropredict-ai-backend -n <namespace>
kubectl argo rollouts get rollout agropredict-ai-worker -n <namespace>
```
...
```bash
kubectl argo rollouts abort agropredict-ai-backend -n <namespace>
kubectl argo rollouts undo agropredict-ai-backend -n <namespace>
```

### 3. Verify Rollback Completion

```bash
kubectl argo rollouts status agropredict-ai-backend -n <namespace>
```
