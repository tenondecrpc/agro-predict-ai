...
def build_credential_rotation_router(
    ...
    *,
    ...
    def upsert_rotation_schedule(
        ...
        telemetry.set_gauge(
            "agropredict_credential_rotation_overdue_count",
    ...
    def evaluate_rotation_schedule(
        ...
        telemetry.set_gauge(
            "agropredict_credential_rotation_warning_count",
            float(warning_count),
        )

        if overdue_count > 0:
            telemetry.increment(
                "agropredict_credential_rotation_overdue_alerts_total",
                count=overdue_count,
            )
    ...
    def approve_break_glass(
        ...
        telemetry.increment(
            "agropredict_break_glass_approvals_total",
