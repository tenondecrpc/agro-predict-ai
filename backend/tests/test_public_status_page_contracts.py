...
def test_public_status_page_reflects_prometheus_backed_degradation() -> None:
    ...
    persistence.telemetry.set_gauge("agropredict_dlq_depth", 150.0)
    persistence.telemetry.set_gauge("agropredict_provider_circuit_breaker_state", 2.0, provider_id="llm-a")
